...
option.list <- list(
    make_option("--figdir", type="character", default="/oak/stanford/groups/engreitz/Users/kangh/TeloHAEC_Perturb-seq_2kG/211206_ctrl_only_snakemake/figures/all_genes/2kG.library.ctrl.only/K60/threshold_0_2/", help="Figure directory"),
...
## write table
write.table(df.all, file=paste0(OUTDIRSAMPLE, "/cNMF.PoPS.input.to.large.table.pipeline_", SUBSCRIPT, ".", gsub(paste0("_cNMF", k), "", PREFIX), ".txt"), row.names=F, quote=F, sep="\t")
