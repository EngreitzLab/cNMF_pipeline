...
rule PoPS_plots:
	...
	output: ## double check: threshold
		...
		all_coef_beta_plot = os.path.join(config["figDir"], "{magma_prefix}_all.coef.beta.pdf"),
		PoPS_score_list_plot = os.path.join(config["figDir"], "{magma_prefix}_PoPS_score_list.pdf")
